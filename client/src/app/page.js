...
export default function LandingPage() {
  ...
  useEffect(() => {
    if (isConnected) {
      console.log("LandingPage: Connected, navigating...");
  ...
  useEffect(() => {
    if (connectError) {
      ...
      setShowError(connectError.shortMessage || "Failed to connect wallet.");
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setCryptoPrice((prev) => ({
        ...
        rbtc: prev.rbtc * (1 + (Math.random() * 0.01 - 0.005)),
      }));
    }, 3000);
  ...
  if (isAccountConnecting || isReconnecting) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-gray-900 to-indigo-950">
          ...
          <div className="container mx-auto px-4 py-20 md:py-32 flex flex-col md:flex-row items-center gap-12">
            ...
            >
              <div className="flex items-center gap-2 mb-8">
                ...
                <span className="font-bold text-2xl">RootInvest</span>{" "}
              </div>
              <motion.h1
                variants={fadeIn}
              ...
              >
                {" "}
                Smart Decentralized Investing on{" "}
              ...
              <motion.p variants={fadeIn} className="text-xl text-gray-300">
                ...
                (Decks), or create your own. Powered by Bitcoins security via
                Rootstock.{" "}
              </motion.p>
              ...
              >
                <motion.div
                  className="bg-gray-800/50 backdrop-blur-sm rounded-lg px-4 py-2 border border-gray-700/50"
                  variants={fadeIn}
                  whileHover={{ scale: 1.05 }}
                >
                  {" "}
                  <div className="text-xs text-gray-400">BTC</div>{" "}
                  <div className="text-lg font-medium">96,994.06</div>{" "}
                </motion.div>
                <motion.div
                  className="bg-gray-800/50 backdrop-blur-sm rounded-lg px-4 py-2 border border-gray-700/50"
                  variants={fadeIn}
                ...
                >
                  ...
                  <div className="text-lg font-medium">1,837.07</div>{" "}
                </motion.div>
                <motion.div
                  className="bg-gray-800/50 backdrop-blur-sm rounded-lg px-4 py-2 border border-gray-700/50"
                  variants={fadeIn}
                ...
                >
                  {" "}
                  <div className="text-xs text-gray-400">RBTC</div>{" "}
                  <div className="text-lg font-medium">93,304.64</div>{" "}
                </motion.div>
              </motion.div>
            </motion.div>
            ...
            >
              ...
              >
                ...
                <div className="text-4xl font-bold">
                  $<CountUp end={12.5} decimals={1} duration={2.5} suffix="M" />
                </div>{" "}
              </motion.div>
              <motion.div
                className="bg-gray-800/30 backdrop-blur-sm rounded-xl p-6 border border-gray-700/50"
              ...
              >
                ...
                <div className="text-4xl font-bold">
                  <CountUp end={8750} duration={2.5} separator="," />
                </div>{" "}
              </motion.div>
              <motion.div
                className="bg-gray-800/30 backdrop-blur-sm rounded-xl p-6 border border-gray-700/50"
              ...
              >
                ...
                <div className="text-4xl font-bold">
                  <CountUp end={18.7} decimals={1} duration={2.5} suffix="%" />
                </div>{" "}
              </motion.div>
            </motion.div>
          </div>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-gray-300 max-w-2xl mx-auto">
                {" "}
                Track your investments with real-time analytics and
        ...
        <section id="features" className="py-20">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-gray-300 max-w-2xl mx-auto">
                {" "}
                RootInvest makes decentralized investing simple, secure, and
                smart with our innovative platform.{" "}
              </p>{" "}
            </motion.div>
            <motion.div
              className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"
            ...
            >
              <FeatureCard
                ...
                description="Explore diverse investment Decks. Utilize our AI Risk Analyzer Bot to assess potential downsides before investing."
                variants={fadeIn}
              />
              <FeatureCard
                icon={Wallet}
                title="Invest with Ease"
                description="Connect your wallet and invest directly into chosen Decks using our native PTK token. Buy PTK easily using RBTC."
                variants={fadeIn}
              />
              <FeatureCard
                icon={BarChart3}
                title="Manage & Track"
                description="Monitor investments in real-time on your personal dashboard. Track performance and withdraw earned profits seamlessly."
                variants={fadeIn}
              />
              <FeatureCard
                icon={Plus}
                title="Create & Share"
                description="Design and launch your own investment Decks for the community to invest in (Creator fee applies)."
                variants={fadeIn}
              />
            </motion.div>
          </div>
        ...
        <section id="benefits" className="py-20 bg-gray-950/50">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-gray-300 max-w-2xl mx-auto">
                {" "}
                Our platform offers unique advantages that set us apart in the
                DeFi space.{" "}
              </p>{" "}
            </motion.div>
            <motion.div
            ...
            >
              <BenefitCard
                icon={Shield}
                title="Rootstock Security"
                description="Leverage the security of the Bitcoin network for your DeFi investments."
                variants={fadeIn}
              />
              <BenefitCard
                icon={PieChart}
                title="Simplified DeFi"
                description="Access complex strategies through easy-to-understand Decks."
                variants={fadeIn}
              />
              <BenefitCard
                icon={Brain}
                title="AI-Powered Insights"
                description="Make informed decisions with our integrated Risk Analyzer and Chatbot."
                variants={fadeIn}
              />
              <BenefitCard
                icon={MessageCircle}
                title="Community & Creation"
                description="Participate in a growing ecosystem or become a strategy creator."
                variants={fadeIn}
              />
            </motion.div>
          </div>
